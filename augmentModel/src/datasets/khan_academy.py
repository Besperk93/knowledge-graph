...
class KhanAcademyMathDataset(BaseMathDataset):
    ...
    def initialize(self):
        ...
        # NOTE: The dataset seems to have been compressed such that all json files are in subdirectories. Turning all_filenames into a generator that searches each.
        all_filenames = glob.iglob(f"{self.dataroot}/**/*.json", recursive=True)
