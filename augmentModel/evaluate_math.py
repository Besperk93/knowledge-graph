...
from src.model.model import KnowGPT2LMHeadModel
...
from src.datasets.util import clean_numbers, last_boxed_only, last_boxed_only_string
...
def run_eval(args):
    ...
    if args.load is None:
        ...
        model = KnowGPT2LMHeadModel.from_pretrained(args.load)
