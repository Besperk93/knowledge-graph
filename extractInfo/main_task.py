...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data", type=str, default='./Vault/mtb/eval/semeval2010_task8/TRAIN_FILE.TXT',
                        help="training data .txt file path")
    parser.add_argument("--test_data", type=str, default='./Vault/mtb/eval/semeval2010_task8/SemEval2010_task8_testing_keys/TEST_FILE_FULL.TXT', \
