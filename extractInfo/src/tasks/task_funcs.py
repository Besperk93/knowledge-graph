...
def load_state(net, optimizer, scheduler, args, load_best=False):
    ...
    # NOTE: Build path to trained models
    ...
    # Establish model hyperparameters
    if checkpoint != None:
...
def load_results():
    ...
    losses_path = "./Vault/mtb/output/task_test_losses_per_epoch.pkl"
    accuracy_path = "./Vault/mtb/output/task_train_accuracy_per_epoch.pkl"
    f1_path = "./Vault/mtb/output/task_test_f1_per_epoch.pkl"
