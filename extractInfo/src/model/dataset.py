...
def create_pretraining_corpus(raw_text, nlp, window_size=40):
    ...
    for i in tqdm(range(len(ents))):
        ...
        for j in range(1, len(ents) - i):
            ...
            if (1 <= (e2start - e1end) <= window_size): # check if next nearest entity within window_size
                ...
                punc_token = False
                # NOTE: is this always the start of the sentence?
                start = e1start - 1
                if start > 0:
    ...
    # NOTE: Printing out some samples for debugging
    ...
    # NOTE: What is this doing? It looks like it's processing the dataset again by dependency tree parsing - is this neccessary?
...
class pretrain_dataset(Dataset):
    ...
    def __init__(self, D, batch_size=None):
        ...
        # NOTE: I'm not sure what this is - check hugging face docs
...
def load_dataloaders(args, data_path, max_length=50000):
    ...
    train_set = pretrain_dataset(args, D, batch_size=args.per_device_train_batch_size)
