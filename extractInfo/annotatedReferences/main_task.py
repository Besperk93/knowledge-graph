...
if __name__ == "__main__":
    ...
    if args.task == 'fewrel':
        ...
        with open("data/fewrel_meta_input.txt", 'w') as out_file:
            json.dump(meta_input, out_file)
        with open("data/fewrel_e1_e2_start.txt", 'w') as out_file:
            json.dump(meta_input, out_file)
        with open("data/fewrel_meta_labels.txt", 'w') as out_file:
            json.dump(meta_input, out_file)
        with open("data/fewrel_outputs.txt", 'w') as out_file:
            json.dump(meta_input, out_file)
