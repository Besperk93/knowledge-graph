...
class infer_from_trained(object):
    ...
    def get_e1e2_start(self, x):
        # NOTE: I reckon this can be changed. List comprehensions are powerful but difficult to read, maybe focus on getting the ID's from self
    ...
    def infer_one_sentence(self, sentence):
        # NOTE: Figure out what this is doing in more detail
        self.net.eval()
